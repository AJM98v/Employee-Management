                ...
                @else
                    <form class="grid grid-cols-2 gap-3" wire:submit.prevent="store()">
                        ...
                        <button type="submit" @click="message = true"
                                ...
                                Update @else Save @endif City
                        </button>

                    </form>
                    <button @click="modal=false; $wire.defualt()"  class="w-20 py-1 text-white bg-gray-800 rounded-xl mt-2">Close</button>
